...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        success_split=filtered_df['class'].value_counts().reset_index()
        success_split.columns=['Status', 'Count']
        fig=px.pie(success_split, values='Count', names='Status', title=f'Launch Success vs Failure for Site {entered_site}')
    return fig
...
def update_scatter_chart(entered_site, payload_range):
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f'Payload vs Launch Outcome at {entered_site}')
    return fig
